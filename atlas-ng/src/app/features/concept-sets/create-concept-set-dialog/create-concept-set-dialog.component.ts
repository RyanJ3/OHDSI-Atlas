    ...
    <mat-dialog-content>
      <form [formGroup]="form" class="create-form">
        <mat-form-field appearance="outline" class="full-width">
          ...
          <input matInput formControlName="name" placeholder="Enter concept set name" />
        ...
        <mat-form-field appearance="outline" class="full-width">
          ...
          <textarea
            ...
            placeholder="Describe the concept set..."
            rows="3"
          ></textarea>
        </mat-form-field>
        ...
        <div class="info-box">
          ...
          <span>After creating the concept set, you'll be able to add concepts using the vocabulary search.</span>
        </div>
      </form>
    </mat-dialog-content>
